...
parser.add_argument('--num_layers', default=10, type=int,
                    help='number of layers in MS-TCN')
...
parser.add_argument('--embed_path_suff', default='', type=str,
                    help='suffix of the embedding folder')
...
###########################################
parser.add_argument('--use_gt_cls', default=False, type=bool)
parser.add_argument('--cls_epochs', default=15, type=int)
parser.add_argument('--first_cls_epochs', default=15, type=int)
parser.add_argument('--vq_model_path', type=str)
parser.add_argument('--clustering_method', type=str)
parser.add_argument('--vq_dim', default=64, type=int)
parser.add_argument('--ema_dead_code', default=3, type=int)
parser.add_argument('--update_w_cls_emb', default=False, type=bool)
parser.add_argument('--vq_decay', default=0.8, type=float)
